var __dsPreview = (() => {
  ...
  // .design-sync/previews/ImpactMetrics.tsx
  var ImpactMetrics_exports = {};
  __export(ImpactMetrics_exports, {
    Default: () => Default,
    LargerCoverage: () => LargerCoverage
  });
  init_define_import_meta_env();
  ...
  return __toCommonJS(ImpactMetrics_exports);
})();
