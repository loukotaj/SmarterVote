...
class TestReferenceSystem:
    ...
    def test_backward_compatibility(self):
        ...
        direct_content = [{"data": "direct_content_1"}, {"data": "direct_content_2"}]
    ...
    def test_artifact_size_improvement(self, tmp_path):
        ...
        old_artifact = {"step": "test_step", "output": large_content}
...
def test_reference_system_integration():
    ...
    if fetch_output.get("type") == "content_collection_refs":
        ...
        for item in raw_content:
            processed_content.append({"source": item["source"], "text": f"Processed: {item['content']}", "word_count": 10})
