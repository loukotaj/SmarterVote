...
echo "   - docker build -f pipeline_client/Dockerfile -t $REGION-docker.pkg.dev/$PROJECT_ID/smartervote-dev/pipeline-client:latest ."
echo "   - docker push $REGION-docker.pkg.dev/$PROJECT_ID/smartervote-dev/pipeline-client:latest"
