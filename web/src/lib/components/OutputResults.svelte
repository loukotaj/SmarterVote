    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex space-x-2">
        <button
          ...
          title={outputTooLarge
            ? "Output too large to copy safely"
            : "Copy to clipboard"}
        >
          Copy
        </button>
        ...
        <div class="flex items-start">
          ...
          <div>
            ...
            <p class="text-sm text-yellow-700 mt-1">
              This output is very large and has been truncated for display. Use
              the "Download" button to get the complete result.
            </p>
          </div>
        </div>
      </div>
