...
class WebContentFetcher:
    ...
    def __init__(self):
        ...
        self._tracking_params = {
            ...
            'gclid', 'fbclid', 'msclkid', 'igshid', '_ga', '_gid'
        }
    ...
    async def _fetch_with_httpx(self, source: Source, canonical_url: str) -> Dict[str, Any]:
        ...
        is_text_content = any(text_type in content_type for text_type in [
    ...
    def _selenium_fetch_sync(self, source: Source, canonical_url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "fetch_duration_seconds": fetch_duration,
                "method": "selenium",
                "detected_source_type": SourceType.SOCIAL_MEDIA if source.type == SourceType.SOCIAL_MEDIA else SourceType.WEBSITE,
