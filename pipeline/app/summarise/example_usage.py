...
def create_sample_content() -> list:
    ...
    return [
        ExtractedContent(
            ...
            text="""
            Senator Jane Smith has served in the US Senate for 8 years, representing the state of California. 
            She chairs the Healthcare Subcommittee and has authored three major pieces of healthcare legislation. 
            On economic policy, she supports increased infrastructure spending and tax credits for renewable energy companies. 
            Her voting record shows consistent support for environmental protection measures and consumer rights legislation.
            """,
        ...
        ExtractedContent(
            ...
            text="""
            In a recent interview, Senator Smith outlined her key priorities for the upcoming term. 
            She emphasized the need for comprehensive healthcare reform, including expanding Medicare eligibility 
            and reducing prescription drug costs. On climate change, she supports the Green New Deal and has 
            proposed legislation for carbon pricing. She also advocates for campaign finance reform and 
            increased federal funding for education and scientific research.
            """,
        ...
        ExtractedContent(
            ...
            text="""
            Voting Record Analysis: Senator Smith voted YES on the Infrastructure Investment Act (2022), 
            YES on the Climate Action Bill (2023), YES on the Healthcare Accessibility Act (2021), 
            and NO on the Corporate Tax Reduction Act (2022). She has a 95% attendance rate for committee hearings 
            and has sponsored or co-sponsored 47 bills in the current session.
            """,
