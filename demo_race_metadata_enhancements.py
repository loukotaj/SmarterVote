...
def demonstrate_enhanced_metadata_service():
    ...
    candidates = [
        ...
        DiscoveredCandidate(
            name="Mike Thompson", party="Republican", incumbent=False, sources=["https://ballotpedia.org/mike-thompson"]
        ),
        DiscoveredCandidate(
            name="Alex Rivera", party="Independent", incumbent=False, sources=["https://wikipedia.org/alex-rivera"]
        ),
    ]
