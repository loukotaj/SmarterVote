...
from shared.forecast_summary import _chamber_races, normalize_party
...
async def main():
    ...
    for r in gov_races:
        ...
        norm_winner = normalize_party(winner)
        print(f"ID: {r.get('id')}, Winner: {winner} (normalized: {norm_winner})")
